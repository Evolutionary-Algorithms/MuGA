 ...
 */
public class PeekSucessRate extends AbstractStatistics {

    public PeekSucessRate() {
        super("Suceess All Peeks");
        higherIsBetter = true;
    }
    ...
    public double execute(EAsolver s) {
        if (s.parents.getIndividual(0) instanceof MultiModalFunc && s.hallOfFame.get(0).isOptimum()) {
            ...
            return s.hallOfFame.size() >= problem.getNumGlobalOptima() ? 1 : 0;
        }
        return 0;
    }
    ...
    public String getInformation() {
        return "Peek Sucess Rate"
                + "\nFound all the optima";
    }
